...
import csv
from two_robot_dueling_ablation_bcd.models.multi_robot_network import MultiRobotNetworkModel
from two_robot_dueling_ablation_bcd.environment.multi_robot_no_unknown import Robot
from two_robot_dueling_ablation_bcd.config import MODEL_CONFIG, MODEL_DIR
from two_robot_dueling_ablation_bcd.environment.robot_local_map_tracker import RobotIndividualMapTracker
...
def main():
    # 指定模型路徑
    model_path = os.path.join(MODEL_DIR, 'bcd.h5')
