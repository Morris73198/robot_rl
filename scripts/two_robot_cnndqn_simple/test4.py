...
from two_robot_cnndqn_simple.environment.robot_local_map_tracker import RobotIndividualMapTracker
...
def main():
    # 指定模型路徑
    model_path = os.path.join(MODEL_DIR, 'dueling2.h5')
    ...
    # 設置輸出目錄
    output_dir = 'results_multi_startpoints11111'
