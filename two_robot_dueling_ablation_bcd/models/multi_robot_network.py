...
class MultiRobotNetworkModel:
    ...
    def _build_simple_perception_module(self, inputs):
        """使用network2中的CNN架構處理地圖輸入，移除空間注意力模塊(A)"""
        # 使用network2中的CNN架構
    ...
    def _build_model(self):
        ...
        # 1. 地圖感知處理 - 使用簡化的CNN (移除A)
        map_features = self._build_simple_perception_module(map_input)
