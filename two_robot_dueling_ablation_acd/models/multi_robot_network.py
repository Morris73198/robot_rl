...
class MultiRobotNetworkModel:
    def __init__(self, input_shape=(84, 84, 1), max_frontiers=50):
        ...
        self.d_model = 128  # 較小的維度，因為沒有機器人間協調
        self.num_heads = 4  # 較少的注意力頭數
        self.dff = 256  # 前饋網路維度
    ...
    def _build_model(self):
        ...
        # 3. Frontier評估，包含前沿注意力 (C)
        robot1_frontier = self._build_frontier_module(frontier_input, robot1_features)
        robot2_frontier = self._build_frontier_module(frontier_input, robot2_features)
